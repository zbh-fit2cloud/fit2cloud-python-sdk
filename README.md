...
8. 列出集群内某虚拟机组内所有虚拟机，通过集群名称,虚拟机组名称
$ ./f2cs.py listClusterVmGroupVms --cluster-name=wordpress-all-in-one --vmgroup-name=wd-all-in-one
